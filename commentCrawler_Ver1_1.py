   ...
   while 1:
      ...
      if data['data']['replies']:   #获取评论
         for item in data['data']['replies']:
            comment.append({'Name':item['member']['uname'],'Comment':item['content']['message'],'Like':item['like']})
            ...
            if item.get('replies'): #获取评论下的回复
               ...
               while 1:
                  ...
                  for reply in replies:
                     comment.append({'Name':reply['member']['uname'],'Comment':reply['content']['message'],'Like':reply['like']})
                  rp_page += 1
